  ...
  <section class="parallax-window" id="short" data-parallax="scroll" data-image-src="img/sub_header_cart.jpg" data-natural-width="1400" data-natural-height="350">
    <div id="subheader">
      <div id="sub_content">
       ...
       <a target="_blank" style="color: #ffffff;" href="<?=$site;?>Demo"><button class="btn" style="font-size: 25px; background-color: #0065CA; border-radius: 50px; width: 250px; height: 50px;">DEMONSTRAÇÃO</button></a>
       <p></p>
     </div><!-- End sub_content -->
   </div><!-- End subheader -->
   <?php
