				...
				<div class="mg-b-10" align="center">
					<?php if($_POST['opcao_delivery'] == 'true'): ?>
						...
						<div class="box_style_2" id="order_process">				
							<div style="text-transform: uppercase;font-weight: 700;font-size: 13px;color: #343a40;letter-spacing: 1px;"><i class="fa fa-caret-right"></i> INFORME OS DADOS ABAIXO</div>	
							<br />				
							...
							<?php if($_POST['opcao_delivery'] == 'false2'):?>						
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											<label class="form-control-label"><span style="color: red;">*</span> Nº da Mesa:</label>
											<input type="number" name="mesa" class="form-control numero" maxlength="2" required>
										</div>
									</div>
									<div class="col-lg-6">
										<div class="form-group">
											<label class="form-control-label"><span style="color: red;">*</span> Quantidade de Pessoas:</label>
								...
								<div class="col-md-12">
									<div class="form-group">								
										<div class="icheck-material-green">
											...
											<label for="green"><strong>Agilize o seu pedido enviando para o whatsapp do estabelecimento. "Você precisa confirmar o envio no APP."</strong></label>
										</div>
									</div>
								</div>
					...
					<div class="col-md-3" id="sidebar">
						...
						<div class="theiaStickySidebar">
							...
							<table class="table table_summary">
								...
								<button class="btn_full enviarpedido"><?=$texto['msg_pedir_agora'];?></button>
								<script type="text/javascript">
									$(document).ready(function(){
